 ...
 // 
  const onSubmit = (e) => {
    ...
    return (
        <>
            <h1>Branches</h1>
        <h4>Edit Branch</h4><br></br>
       <Form onSubmit={onSubmit}>

    <Form.Group >
      <Form.Label>Name</Form.Label>
      <Form.Control type="text" placeholder="Enter Branch Name"
      id="Name" name="name" onChange={handleForm} value={Branch.name} 
      />
    </Form.Group>
    ...
    <Form.Group >
      ...
      id="adress" name="location" onChange={handleForm} value={Branch.location} 
      />
    </Form.Group>

    <Form.Group >
      <Form.Label>Manager</Form.Label>
      <Form.Control type="text" placeholder="Enter Branch manager"
      id="Manager" name="manager" onChange={handleForm} value={Branch.manager} 
      />
    </Form.Group>
  ...
  <Form.Group  style={{margin:"5px"}}>
      ...
      <Form.Control type="number" placeholder="NO.Tracks"
       id="Tnum" name="no_tracks" onChange={handleForm} value={Branch.no_tracks} 
      />
    </Form.Group>
    ...
    <Form.Group style={{margin:"5px"}}>
      ...
      <Form.Control type="number" placeholder="NO.Students"
       id="Snum" name="no_students" onChange={handleForm} value={Branch.no_students} 
      />
    </Form.Group>
    ...
    <Form.Group  style={{margin:"5px"}}>
      ...
      id="Inum" name="no_instructors" onChange={handleForm} value={Branch.no_instructors} 
      />
    </Form.Group>
