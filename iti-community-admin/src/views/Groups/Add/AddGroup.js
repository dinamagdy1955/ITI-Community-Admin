            ...
            <div className='container'>
                <CForm>
                    <CFormGroup className='mx-auto w-50'>
                        ...
                        <CInput id="name" placeholder="Enter Group name" name="Name" onChange={handleForm} value={Group.Name} required />
                        ...
                        <CInput id="img" placeholder="Enter Group Img URL" required name="URL" onChange={handleForm} value={Group.ImgURL} />
                        <CCardFooter className='mt-3 rounded'>
                            <div className='text-center'>
                                <Link to="/Groups/All">
                                    <CButton type='button' color="info" size="sm" className='w-25 mx-1' onClick={addNew} >
                                        Add
                                    </CButton>
                                </Link>
